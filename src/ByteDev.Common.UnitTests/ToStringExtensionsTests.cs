...
namespace ByteDev.Common.UnitTests
{
    ...
    public class ToStringHelperTests
    {
        ...
        public class ToStringObject : ToStringHelperTests
        {
            ...
            {
                Assert.Throws<ArgumentNullOrEmptyException>(() => new ToStringHelper().ToString(null, 1));
            }

            [Test]
            public void WhenNameIsEmpty_ThenThrowException()
            {
                Assert.Throws<ArgumentNullOrEmptyException>(() => new ToStringHelper().ToString(string.Empty, 1));
            }
